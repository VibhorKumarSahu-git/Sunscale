  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 glass-card rounded-lg text-slate-200 hover:text-cyan-400 transition-all duration-300 print:hidden btn-press hover:scale-105 electric-hover"
      >
